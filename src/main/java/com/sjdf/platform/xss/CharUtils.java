...
/**
 * Create at 2013年11月11日 下午6:01:38
 *
...
public abstract class CharUtils {
    ...
    public static int toIntValue(char ch) {
        ...
        return ch - CommonPlatformConstant.LENGTH_48;
    }
    ...
    public static String toString(char ch) {
        if (ch < CommonPlatformConstant.LENGTH_128) {
    ...
    public static boolean isAscii(char ch) {
        return ch < CommonPlatformConstant.LENGTH_128;
    }
    ...
    public static boolean isAsciiPrintable(char ch) {
        return ch >= CommonPlatformConstant.LENGTH_32 && ch < CommonPlatformConstant.LENGTH_127;
    }
