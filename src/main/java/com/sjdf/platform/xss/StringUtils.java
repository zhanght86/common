...
/**
 * Create at 2013年11月11日 下午6:04:27
 *
 * @category author KETQI
 */
public abstract class StringUtils {
    ...
    public static String strip(String str, String stripChars) {
        ...
        String string = stripStart(str, stripChars);
    ...
    public static String stripAccents(String input) {
        ...
        try {
            String result;
            if (InitStripAccents.JAVA6NORMALIZE_METHOD != null) {
                result = removeAccentsJava6(input);
            } else if (InitStripAccents.SUN_DECOMPOSE_METHOD != null) {
                result = removeAccentsSUN(input);
            } else {
                throw new UnsupportedOperationException("The stripAccents(CharSequence) method requires at least" + " Java6, but got: " + InitStripAccents.JAVA6EXCEPTION + "; or a Sun JVM: " + InitStripAccents.SUN_EXCEPTION);
            }
    ...
    private static String removeAccentsJava6(CharSequence text) throws IllegalAccessException, InvocationTargetException {
        if (InitStripAccents.JAVA6NORMALIZE_METHOD == null || InitStripAccents.JAVA6NORMALIZER_FORM_NFD == null) {
            throw new IllegalStateException("java.text.Normalizer is not available", InitStripAccents.JAVA6EXCEPTION);
        }
        String result;
        result = (String) InitStripAccents.JAVA6NORMALIZE_METHOD.invoke(null, new Object[]{text, InitStripAccents.JAVA6NORMALIZER_FORM_NFD});
    ...
    private static String removeAccentsSUN(CharSequence text) throws IllegalAccessException, InvocationTargetException {
        if (InitStripAccents.SUN_DECOMPOSE_METHOD == null) {
            throw new IllegalStateException("sun.text.Normalizer is not available", InitStripAccents.SUN_EXCEPTION);
        }
        String result;
        result = (String) InitStripAccents.SUN_DECOMPOSE_METHOD.invoke(null, new Object[]{text, Boolean.FALSE, Integer.valueOf(0)});
        result = InitStripAccents.SUN_PATTERN.matcher(result).replaceAll("");//$NON-NLS-1$
        return result;
    }

    /**
     * IOD container for stripAccent() initialisation Create at 2013年11月26日
     * 下午3:03:47
     *
     * @author KETQI
     */
    private static class InitStripAccents {
        ...
        private static final Throwable SUN_EXCEPTION;
        private static final Method SUN_DECOMPOSE_METHOD;
        private static final Pattern SUN_PATTERN = Pattern.compile("\\p{InCombiningDiacriticalMarks}+");//$NON-NLS-1$
        // Java 6+
        private static final Throwable JAVA6EXCEPTION;
        private static final Method JAVA6NORMALIZE_METHOD;
        private static final Object JAVA6NORMALIZER_FORM_NFD;
        private static final Pattern JAVA6PATTERN = SUN_PATTERN;

        static {
            // Set up defaults for final static fields
            Object java6NormalizerFormNFD = null;
            Method java6NormalizeMethod = null;
            Method sunDecomposeMethod = null;
            Throwable java6Exception = null;
            Throwable sunException = null;
            try {
                ...
                java6NormalizeMethod = normalizerClass.getMethod("normalize",//$NON-NLS-1$
                ...
                try {
                    ...
                    sunDecomposeMethod = normalizerClass.getMethod("decompose",//$NON-NLS-1$
            ...
            JAVA6EXCEPTION = java6Exception;
            JAVA6NORMALIZER_FORM_NFD = java6NormalizerFormNFD;
            JAVA6NORMALIZE_METHOD = java6NormalizeMethod;
            SUN_EXCEPTION = sunException;
            SUN_DECOMPOSE_METHOD = sunDecomposeMethod;
        }
    }
    ...
    public static String replace(String text, String searchString, String replacement, int maximum) {
        ...
        increase *= max < 0 ? CommonPlatformConstant.LENGTH_16 : max > CommonPlatformConstant.LENGTH_64 ? CommonPlatformConstant.LENGTH_64 : max;
    ...
    private static String replaceEach(String text, String[] searchList, String[] replacementList, boolean repeat, int timeToLive) {
        ...
        for (int i = 0; i < searchList.length; i++) {
            ...
            if (greater > 0) {
                increase += CommonPlatformConstant.LENGTH_3 * greater;
            }
        }
        // have upper-bound at 20% increase, then let Java take over
        increase = Math.min(increase, text.length() / CommonPlatformConstant.LENGTH_5);
    ...
    public static String repeat(String str, int repeat) {
        ...
        switch (inputLength) {
            ...
            case CommonPlatformConstant.LENGTH_2:
                ...
                for (int i = repeat * CommonPlatformConstant.LENGTH_2 - CommonPlatformConstant.LENGTH_2; i >= 0; i--, i--) {
                    output2[i] = ch0;
                    output2[i + 1] = ch1;
                }
    ...
    public static String abbreviateMiddle(String str, String middle, int length) {
        ...
        int startOffset = targetSting / CommonPlatformConstant.LENGTH_2 + targetSting % CommonPlatformConstant.LENGTH_2;
