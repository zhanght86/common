...
import com.sjdf.platform.xss.translate.*;

import java.io.IOException;
import java.io.Writer;

/**
 * Create at 2013年11月11日 下午5:48:02
 *
 * @author KETQI
...
public abstract class StringEscapeUtils {
     ...
     * @since 3.0
     */
    public static final CharSequenceTranslator ESCAPE_JAVA = new LookupTranslator(new String[][]{{"\"", "\\\""}, {"\\", "\\\\"},}).with(new LookupTranslator(EntityArrays.javaCtrlCharsEscape())).with(UnicodeEscaper.outsideOf(32, 0x7f));
     ...
     * @since 3.0
     */
    public static final CharSequenceTranslator ESCAPE_ECMASCRIPT = new AggregateTranslator(new LookupTranslator(new String[][]{{"'", "\\'"}, {"\"", "\\\""}, {"\\", "\\\\"}, {"/", "\\/"}}), new LookupTranslator(EntityArrays.javaCtrlCharsEscape()), UnicodeEscaper.outsideOf(32, 0x7f));
     ...
     * @since 3.0
     */
    public static final CharSequenceTranslator ESCAPE_XML = new AggregateTranslator(new LookupTranslator(EntityArrays.basicEscape()), new LookupTranslator(EntityArrays.aposEscape()));
     ...
     * @since 3.0
     */
    public static final CharSequenceTranslator ESCAPE_HTML3 = new AggregateTranslator(new LookupTranslator(EntityArrays.basicEscape()), new LookupTranslator(EntityArrays.iso8859Escape()));
     ...
     * @since 3.0
     */
    public static final CharSequenceTranslator ESCAPE_HTML4 = new AggregateTranslator(new LookupTranslator(EntityArrays.basicEscape()), new LookupTranslator(EntityArrays.iso8859Escape()), new LookupTranslator(EntityArrays.html40ExtendedEscape()));

    /**
     * Translator object for escaping individual Comma Separated Values.
     * <p/>
     * While {@link #escapeCsv(String)} is the expected method of use, this
     * object allows the CSV escaping functionality to be used as the foundation
     * for a custom translator.
     *
     * @since 3.0
     */
    ...
    /**
     * Create a parent class - 'SinglePassTranslator' ? It would handle the
     * index checking + length returning, and could also have an optimization
     * check method.
     * <p/>
     * Create at 2013年11月26日 下午3:02:12
     */
    ...
    public static final CharSequenceTranslator UNESCAPE_JAVA = new AggregateTranslator(new OctalUnescaper(), // .between('\1',
            // '\377'),
            new UnicodeUnescaper(), new LookupTranslator(EntityArrays.javaCtrlCharsUnescape()), new LookupTranslator(new String[][]{{"\\\\", "\\"}, {"\\\"", "\""}, {"\\'", "'"}, {"\\", ""}}));
     ...
     * @since 3.0
     */
    public static final CharSequenceTranslator UNESCAPE_HTML3 = new AggregateTranslator(new LookupTranslator(EntityArrays.basicUnescape()), new LookupTranslator(EntityArrays.iso8859Unescape()), new NumericEntityUnescaper());
     ...
     * @since 3.0
     */
    public static final CharSequenceTranslator UNESCAPE_HTML4 = new AggregateTranslator(new LookupTranslator(EntityArrays.basicUnescape()), new LookupTranslator(EntityArrays.iso8859Unescape()), new LookupTranslator(EntityArrays.html40ExtendedEscape()), new NumericEntityUnescaper());
     ...
     * @since 3.0
     */
    public static final CharSequenceTranslator UNESCAPE_XML = new AggregateTranslator(new LookupTranslator(EntityArrays.basicUnescape()), new LookupTranslator(EntityArrays.aposUnescape()), new NumericEntityUnescaper());

    /**
     * Translator object for unescaping escaped Comma Separated Value entries.
     * <p/>
     * While {@link #unescapeCsv(String)} is the expected method of use, this
     * object allows the CSV unescaping functionality to be used as the
     * foundation for a custom translator.
     *
     * @since 3.0
     */
    ...
    /**
     * Create at 2013年11月26日 下午3:02:46
     *
     * @author KETQI
     */
